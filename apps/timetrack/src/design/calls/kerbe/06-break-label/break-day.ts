        ...
        <div class="scroller">
          ...
          <div [style.height.rem]="DAY_HEIGHT_REM" class="axis">
            ...
            @for (mark of marks(); track mark.id) {
              <div
                [style.top.rem]="mark.topRem"
                [style.height.rem]="mark.heightRem"
                [class.brk--dashed]="mark.dashed"
                [class.brk--heavy]="mark.heavy"
                class="brk"
              >
                @for (cell of mark.cells; track cell.key) {
                  <span [style.minWidth.rem]="cell.widthRem" class="brk-cell">
                    @if (cell.carriesLabel) {
                      <span class="brk-label brk-label--cell">Break · {{ mark.minutes }}m</span>
                    }
                  </span>
                }
                @if (mark.floats) {
                  <span class="brk-label brk-label--float">Break · {{ mark.minutes }}m</span>
                }
                @if (mark.inGutter) {
                  <span class="brk-label brk-label--gutter">{{ mark.minutes }}m</span>
                }
                @if (mark.bracket) {
                  <span class="brk-bracket"></span>
                }
                @if (mark.glyph) {
                  <span class="brk-glyph"></span>
                }
                @if (mark.hatchGutter) {
                  <span class="brk-hatch brk-hatch--gutter"></span>
                }
                @if (mark.hatchField) {
                  <span class="brk-hatch brk-hatch--field"></span>
                }
                @if (mark.blockGutter) {
                  <span class="brk-hatch brk-hatch--block"></span>
                }
                @if (mark.heavy) {
                ...
                @if (mark.hatchLoud) {
                  <span class="brk-hatch brk-hatch--loud"></span>
                }
                @if (mark.word) {
                  <span class="brk-word">Break</span>
                }
                @if (mark.wordTurned) {
                  <span class="brk-word brk-word--turned">Break</span>
                }
                @if (mark.signPause) {
                  <span class="brk-sign brk-sign--pause"></span>
                }
                @if (mark.signCup) {
                  <span class="brk-sign"><span class="brk-cup"></span></span>
                }
                @if (mark.pauseVariant) {
                  <span class="brk-sign">
                    <span
                      [class.brk-pause--small]="mark.signSmall"
                      [class.brk-pause--flat]="mark.signFlat"
                      class="brk-pause brk-pause--{{ mark.pauseVariant }}"
                    ></span>
                  </span>
                }
              </div>
...
export class BreakDayComponent {
  public labelAt = input.required<BreakLabelAt>();

  protected marks = computed(() => {
    const labelAt = this.labelAt();
