...
- [Persisted responses](/query/persistence) — on by default: keeping successful reads on disk so a reload, or a cold start with no network, renders the last known data.
