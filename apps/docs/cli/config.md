...
| `updateAgentCommand` | [`et update --ai`](/cli/update)               | The command one agent-assisted migration task is handed to, for example `claude --permission-mode acceptEdits -p`. |
