...
| `et-choice-field`                                   | `--et-choice-field-gap`, `-support-duration`, `-support-offset`, `-label-font-size`, `-error-font-size`, `-warning-font-size`, `-hint-font-size`                                                                                                                                   |
| `et-radio-group` / `et-radio`                       | `--et-radio-group-*` (gap, column gap, label/error/warning/hint sizes, support), `--et-radio-size`, `-dot-size`, `-border-width`, `-transition-duration`, `-opacity-disabled`, `-gap`                                                                                              |
| `et-checkbox-group` / `et-checkbox-option`          | `--et-checkbox-group-*` (gap, column gap, label/error/warning/hint sizes, support), `--et-checkbox-option-size`, `-border-width`, `-border-radius`, `-transition-duration`, `-opacity-disabled`, `-gap`                                                                            |
| `et-segmented-button-group` / `et-segmented-button` | `--et-segmented-button-group-*` (gap, label/error/warning/hint sizes, support, `-track-padding`, `-track-radius`), `--et-segmented-button-padding-x` / `-padding-y`, `-border-radius`, `-transition-duration`, `-opacity-disabled`, `-tab-underline-size`, `-tab-underline-radius` |
| `et-rating`                                         | `--et-rating-icon-size` (`24px`), `--et-rating-gap` (`4px`), `-label-font-size`, `-error-font-size`, `-warning-font-size`, `-hint-font-size`, `-support-duration`, `-support-offset`                                                                                               |
