...
| `et-date-input`, `et-time-input`, `et-date-time-input`, `et-date-range-input`, `et-date-time-range-input`, `et-duration-input` | Field empty with `mixedLabel` placeholder; picker highlights nothing; parse/pick commits      |
