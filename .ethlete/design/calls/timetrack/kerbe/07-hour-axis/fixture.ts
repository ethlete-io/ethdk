import { Band, DayLaneFixture, DayStory, FULL_DAY_LANES, FULL_DAY_STORIES } from '../../shared/kerbe';
...
/** What the axis gives the reader to measure with, between one hour label and the next. */
export type AxisRule = 'hour' | 'gutter-ticks' | 'half-line' | 'ruler';
