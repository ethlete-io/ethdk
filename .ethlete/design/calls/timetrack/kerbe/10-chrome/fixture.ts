...
export const GUTTER_REM = 3.4;
export const HOUR_LABEL_REM = 1.05;
export const HOUR_LABEL_INK = 'var(--k-ink-3)';

/** What the top row of the window carries. */
export type ChromeRule = 'sketch' | 'app' | 'app-total' | 'app-total-mark';
...
export type LaidHour = { hour: number; topRem: number; text: string };
