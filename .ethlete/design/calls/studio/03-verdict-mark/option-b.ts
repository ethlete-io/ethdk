...
const framed = (variant: Variant) =>
  html`${variant.verdict === 'chosen' && 'framed-chosen'} ${variant.verdict === 'rejected' && 'framed-rejected'}`;
...
const thumb = (variant: Variant) => html`
  <div class="thumb ${variant.key === LARGE && 'on'}">
    <div class="thumb-pic ${framed(variant)}">${mini(variant)}</div>
...
const large = (variant: Variant) => html`
  <div class="large">
    <div class="large-pic ${framed(variant)}">${mini(variant)}</div>
