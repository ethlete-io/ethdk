...
const thumb = (variant: Variant) => html`
  <div class="thumb ${variant.key === LARGE && 'on'}">
    ...
    <div class="controls">
      <span class="control ${variant.verdict === 'chosen' && 'pressed-accept'}">Accept</span>
      <span class="control ${variant.verdict === 'rejected' && 'pressed-reject'}">Reject</span>
...
export default drawing({
  ...
  styles: css`
    ...
    .control.pressed-accept {
      border-color: ${ACCENT};
      background: ${ACCENT};
      color: ${GROUND};
    }

    .control.pressed-reject {
      border-color: ${MUTED};
      background: ${LINE};
      color: ${INK};
    }
