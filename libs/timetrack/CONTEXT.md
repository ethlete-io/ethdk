...
between background and foreground work does not happen. An unattended row folds only into a row it
touches, and an attended row never folds into an unattended one.
