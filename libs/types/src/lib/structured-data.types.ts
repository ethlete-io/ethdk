...
interface GrantBase extends ThingBase {
  ...
  fundedItem?: SchemaValue<
    BioChemEntity | CreativeWork | Event | MedicalEntity | Organization | Person | Product | IdReference,
    'fundedItem'
  >;
  /** A person or organization that supports (sponsors) something through some kind of financial contribution. */
  funder?: SchemaValue<Organization | Person | IdReference, 'funder'>;
...
interface HospitalBase extends LocalBusinessBase, MedicalOrganizationBase, CivicStructureBase {
...
interface HowToStepBase extends ItemListBase, CreativeWorkBase, ListItemBase {}
