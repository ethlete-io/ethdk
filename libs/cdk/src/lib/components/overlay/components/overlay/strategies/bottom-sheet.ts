...
export const [injectBottomSheetStrategyDefaults] = createStaticRootProvider<OverlayBreakpointConfig>(
  {
    width: '100%',
    height: undefined,
...
export const [injectBottomSheetStrategy] = createRootProvider(
  () => {
