    ...
    <div class="slot-demo">
      ...
      @if (page() === 'a') {
        <div class="slot-demo-page">
          <p class="slot-demo-page-title">Page A — {{ userId() }}</p>

          <et-soop-player-slot #slotA [userId]="userId()" class="slot-demo-player-slot" />
      ...
      @if (page() === 'b') {
        <div class="slot-demo-page">
          <p class="slot-demo-page-title">Page B — mbcnews</p>

          <et-soop-player-slot #slotB class="slot-demo-player-slot" userId="mbcnews" />
