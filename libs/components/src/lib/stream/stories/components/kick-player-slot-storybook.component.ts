    ...
    <div class="slot-demo">
      ...
      @if (page() === 'a') {
        <div class="slot-demo-page">
          ...
          <et-kick-player-slot #slotA [channel]="channel()" class="slot-demo-player-slot" />
      ...
      @if (page() === 'b') {
        <div class="slot-demo-page">
          <p class="slot-demo-page-title">Page B — asmongold247</p>

          <et-kick-player-slot #slotB class="slot-demo-player-slot" channel="asmongold247" />
