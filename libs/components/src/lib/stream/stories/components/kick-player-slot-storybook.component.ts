...
import { STREAM_IMPORTS, STREAM_KICK_IMPORTS, STREAM_PIP_IMPORTS } from '../../stream.imports';
...
@Component({
  ...
  imports: [STREAM_IMPORTS, STREAM_KICK_IMPORTS, STREAM_PIP_IMPORTS, ButtonComponent, TextButtonComponent, TAB_IMPORTS],
  providers: [
    ...provideStreamConfig({
