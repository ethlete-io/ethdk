    ...
    <div class="bg-neutral-900 rounded-lg overflow-hidden">
      ...
      @if (page() === 'a') {
        <div class="p-5">
          ...
          <et-vimeo-player-slot #slotA [videoId]="videoId()" class="block relative w-full aspect-video bg-black rounded mb-4" />
      ...
      @if (page() === 'b') {
        <div class="p-5">
          ...
          <et-vimeo-player-slot #slotB class="block relative w-full aspect-video bg-black rounded mb-4" videoId="148751763" />
