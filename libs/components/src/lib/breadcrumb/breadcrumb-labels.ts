...
/**
 * Every string the breadcrumb announces. Defaults are English ({@link DEFAULT_BREADCRUMB_LABELS});
 * override them app-wide with {@link provideBreadcrumbLabels} or per instance via the `labels` input.
 */
