...
1. Import the `BottomSheetDefaultProviders` and add it to your main.ts providers array.
...
| --------------------------------------- | ---------------------------------------------------- |
| `--et-bottom-sheet-transition-duration` | **Private!** Change this value via BottomSheetConfig |
