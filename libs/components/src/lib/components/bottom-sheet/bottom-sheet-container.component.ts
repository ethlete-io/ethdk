...
import { DialogContainerBaseComponent } from '../dialog/dialog-container-base.component';
import { DIALOG_CLASSES, TRANSITION_DURATION_PROPERTY } from '../dialog/dialog.constants';
...
export class BottomSheetContainerComponent extends DialogContainerBaseComponent implements OnDestroy {
