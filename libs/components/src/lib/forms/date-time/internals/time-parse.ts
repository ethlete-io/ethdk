...
/**
 * Parses typed time text: strictly against the display format first, then leniently (`930` → 09:30,
 * `9 30`, `930pm`). Returns the time of day on `referenceDate`, or `null` when nothing parses.
 */
