...
> **Status (2026-09-23): programme complete.**
>
> - W0–W18 done; W17 measured and rejected.
> - D2, D3, D5 shipped.
> - D1 done, narrowed by the user: the eight group controls and `et-choice-field` fade with plain
>   opacity; `et-form-field` keeps its direction slide and the `--et-*-support-offset` tokens stay.
> - D4 not doing (user decision, 2026-09-23).
