...
When a term is resolved, update `CONTEXT.md` right there. Don't batch these up: capture them as they happen. Use the format in `.agents/skills/ethlete-domain-modeling/CONTEXT-FORMAT.md`.
...
If any of the three is missing, skip the ADR. Use the format in `.agents/skills/ethlete-domain-modeling/ADR-FORMAT.md`.
