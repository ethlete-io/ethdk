...
`.agents/skills/ethlete-design-exploration/check-story.mjs` to the **repository root** - Node resolves `playwright` from
...
Only after the checks pass. Copy `.agents/skills/ethlete-design-exploration/shoot-template.mjs` to the repository root.
